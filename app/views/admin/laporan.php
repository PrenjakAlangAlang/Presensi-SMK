...
<div class="mb-6">
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex space-x-8">
            ...
            <a href="?action=admin_laporan&tipe=kelas&bulan=<?php echo $bulan ?? date('m'); ?>&tahun=<?php echo $tahun ?? date('Y'); ?>" 
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            ?>
                            <button onclick="editPresensiKelas('<?php echo $p->id; ?>', '<?php echo $p->user_id; ?>', '<?php echo $jadwal_id_val; ?>', '<?php echo $sesi_id_val; ?>', '<?php echo htmlspecialchars($p->nama ?? '', ENT_QUOTES); ?>', '<?php echo $jenis; ?>', '<?php echo htmlspecialchars($alasan, ENT_QUOTES); ?>', '<?php echo htmlspecialchars($foto_bukti, ENT_QUOTES); ?>')" 
                                    class="text-green-600 hover:text-green-800 transition-colors">
                                <i class="fas fa-edit"></i>
                            </button>
                        </td>
...
function exportToPDF() {
    ...
    window.open('<?php echo BASE_URL; ?>/index.php?action=admin_export_pdf&periode=' + periode + '&tanggal=' + tanggal + '&bulan=' + bulan + '&tahun=' + tahun + '&status=' + status + '&tipe=' + tipe + '&tahun_ajaran_filter=' + tahunAjaranFilter + '&semester_filter=' + semesterFilter + '&kelas_filter_id=' + kelasFilterId + '&mapel_id=' + mapelId, '_blank');
}
...
function exportToExcel() {
    ...
    const kelasFilterId = '<?php echo $kelas_filter_id ?? ''; ?>';
    const mapelId = '<?php echo $mapel_id ?? ''; ?>';
    window.location.href = '<?php echo BASE_URL; ?>/index.php?action=admin_export_excel&periode=' + periode + '&tanggal=' + tanggal + '&bulan=' + bulan + '&tahun=' + tahun + '&status=' + status + '&tipe=' + tipe + '&tahun_ajaran_filter=' + tahunAjaranFilter + '&semester_filter=' + semesterFilter + '&kelas_filter_id=' + kelasFilterId + '&mapel_id=' + mapelId;
}
