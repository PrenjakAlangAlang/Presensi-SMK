...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
    ...
    <form method="POST" action="<?php echo BASE_URL; ?>/index.php?action=admin_kesiswaan_save_buku_induk" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
                ...
                record.dokumen.forEach(dok => {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="flex gap-2">
                            ...
                            <form method="POST" action="<?php echo BASE_URL; ?>/index.php?action=admin_kesiswaan_delete_dokumen" 
