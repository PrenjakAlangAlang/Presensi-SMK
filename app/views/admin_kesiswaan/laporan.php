...
function exportToPDF() {
    ...
    window.open('<?php echo BASE_URL; ?>/public/index.php?action=admin_kesiswaan_export_pdf&periode=' + periode + '&tanggal=' + tanggal + '&minggu=' + minggu + '&bulan=' + bulan + '&tahun=' + tahun + '&status=' + status + '&tipe=' + tipe + '&kelas_id=' + kelasId, '_blank');
}
...
function exportToExcel() {
    ...
    const tipe = '<?php echo $tipe_laporan ?? 'sekolah'; ?>';
    const kelasId = '<?php echo $kelas_id ?? ''; ?>';
    window.location.href = '<?php echo BASE_URL; ?>/public/index.php?action=admin_kesiswaan_export_excel&periode=' + periode + '&tanggal=' + tanggal + '&minggu=' + minggu + '&bulan=' + bulan + '&tahun=' + tahun + '&status=' + status + '&tipe=' + tipe + '&kelas_id=' + kelasId;
}
