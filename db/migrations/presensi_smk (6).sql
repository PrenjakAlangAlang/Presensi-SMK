...
--
-- Host: localhost:3306
-- Generation Time: Mar 04, 2026 at 07:01 AM
...
INSERT INTO `mata_pelajaran` (`id`, `nama_mata_pelajaran`, `tahun_ajaran`, `guru_pengampu`, `jadwal`) VALUES
...
ALTER TABLE `mata_pelajaran`
  ADD PRIMARY KEY (`id`),
  ADD KEY `wali_kelas` (`guru_pengampu`);
...
--
ALTER TABLE `mata_pelajaran`
  ADD CONSTRAINT `mata_pelajaran_ibfk_1` FOREIGN KEY (`guru_pengampu`) REFERENCES `users` (`id`) ON DELETE SET NULL;
