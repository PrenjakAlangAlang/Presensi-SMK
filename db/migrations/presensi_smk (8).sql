...
INSERT INTO `kelas` (`id`, `nama_kelas`, `tahun_ajaran`, `wali_kelas_id`) VALUES
(1, 'X TKR 1', '2025/2026', 2),
(2, 'XII Multimedia', '2025/2026', 6);
...
INSERT INTO `presensi_kelas` (`id`, `user_id`, `mata_pelajaran_id`, `latitude`, `longitude`, `jarak`, `status`, `waktu`, `presensi_sesi_id`, `jenis`, `alasan`, `foto_bukti`) VALUES
...
(383, 114, 3, 0, 0, 0, 'valid', '2026-03-05 20:44:20', 'alpha', 'Tidak hadir saat sesi ditutup', NULL),
(384, 114, 5, 0, 0, 0, 'valid', '2026-03-05 20:44:43', 'alpha', 'Tidak hadir saat sesi ditutup', NULL),
(385, 114, 7, 0, 0, 0, 'valid', '2026-03-05 20:44:43', 'alpha', 'Tidak hadir saat sesi ditutup', NULL),
(386, 114, 8, 0, 0, 0, 'valid', '2026-03-05 20:44:43', 'alpha', 'Tidak hadir saat sesi ditutup', NULL);
...
ALTER TABLE `kelas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_kelas_wali_kelas` (`wali_kelas_id`);
...
ALTER TABLE `presensi_kelas`
  ...
  ADD KEY `fk_presensi_kelas_kelas` (`mata_pelajaran_id`),
...
--
ALTER TABLE `kelas`
  ADD CONSTRAINT `fk_kelas_wali_kelas` FOREIGN KEY (`wali_kelas_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `presensi_kelas`
  ADD CONSTRAINT `fk_presensi_kelas_kelas` FOREIGN KEY (`mata_pelajaran_id`) REFERENCES `mata_pelajaran` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `presensi_kelas_ibfk_2` FOREIGN KEY (`mata_pelajaran_id`) REFERENCES `mata_pelajaran` (`id`) ON DELETE CASCADE,
